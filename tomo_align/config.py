...
from tomo_align import util
from tomo_align import __version__
...
SECTIONS['general'] = {
    ...
    'testing': {
        'default': False,
        'help': "If True, don't actuate shutters."},
        }
...
SECTIONS['detector'] = {
    'tomoscan-prefix':{
        ...
        'help': 'Prefix for tomoScan IOC holding PVs we need'},
    'off-axis-position': {
        'default': 0.1,
        'type': float,
...
SPHERE_PARAMS = ('detector', )

NICE_NAMES = ('general', 'detector',)
